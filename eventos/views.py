...
def gerar_certificado(request, id):
    ...
    for participante in evento.participantes.all():
        ...
        fonte_nome = ImageFont.truetype(path_fonte, 60) # passar o caminho da fonte e o tamanho da fonte
        fonte_info = ImageFont.truetype(path_fonte, 30) # passar o caminho da fonte e o tamanho da fonte

        # escrever um texto na imagem com 4 parametros, as cordenadas, o texto, a fonte, e a cor do texto
